...
Журнал локальных испытаний конфигураций автомобиля и повторяемых физических сценариев.
...
- **Vehicle configuration diffs** — запланированный модуль; реализации нет.
- **Repeatable track scenarios** — запланированный модуль; реализации нет.
- **Telemetry import schema** — запланированный модуль; реализации нет.
...
3. Опишите один контрольный сценарий для **Vehicle configuration diffs**.
...
Зафиксируйте входные данные и ожидаемый результат для модуля 1. Запишите версию BeamNG.drive, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Repeatable track scenarios

Зафиксируйте входные данные и ожидаемый результат для модуля 2. Запишите версию BeamNG.drive, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Telemetry import schema

Зафиксируйте входные данные и ожидаемый результат для модуля 3. Запишите версию BeamNG.drive, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Кратко

| Поле | Значение |
|---|---|
| Продукт или область | BeamNG.drive |
...
| Планируемый результат | Vehicle configuration diffs |
